...
public class Bag {
	...
	private void initBag() {
		...
		for(int i = 0; i < getSize(); i++)
			weight = 0;
		items.add(new Weapon("Standard", "Crowbar", 5, 30));
	}
	...
	/**
	 * 
	 * @param itemIdx index value used for the items ArrayList
	 * @return the Item at the passed in index location
	 */
